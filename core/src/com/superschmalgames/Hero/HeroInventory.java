...
public class HeroInventory {
    ...
    public HeroInventory(){
        ...
        items.add(tmpA);
        tmpA = new ApparelItem("Gator Hat", Utils.gator_hat_tex, "Social", 1.0, 0);
        items.add(tmpA);
        tmpA = new ApparelItem("Graduation Gown", Utils.graduation_gown_tex, "Endurance", 2.0, 0);
        items.add(tmpA);
        tmpA = new ApparelItem("Suit and Tie", Utils.suit_and_tie_tex, "Social", 3.0, 0);
        items.add(tmpA);
        tmpC = new ConsumableItem("Redbull",Utils.redbull_tex,"GPA",0.8,3,0,true);
        items.add(tmpC);
        tmpC = new ConsumableItem("Starbucks",Utils.starbucks_tex,"GPA",1.2,3,0,true);
        items.add(tmpC);
        tmpE = new EquipableItem("AVR Dragon", Utils.avr_dragon_tex, "Hardware", 3.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("Cyclone III", Utils.cyclone_III_tex, "Hardware", 2.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("DAD Board", Utils.dad_board_tex, "Focus", 1.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("Macbook Pro", Utils.macbook_pro_tex, "Software", 1.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("Nspire", Utils.nspire_tex, "Math", 2.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("Soldering Iron", Utils.soldering_iron_tex, "Endurance", 1.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("TI-89", Utils.ti_89_tex, "Math", 1.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("USB Blaster", Utils.usb_blaster_tex, "Software", 2.0, 0);
        items.add(tmpE);
        tmpE = new EquipableItem("Wire Kit", Utils.wire_kit_tex, "Hardware", 1.0, 0);
        items.add(tmpE);
    }
