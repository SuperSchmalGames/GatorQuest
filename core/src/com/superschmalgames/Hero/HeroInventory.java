...
public class HeroInventory {
    ...
    public HeroInventory(){
        ...
        items.add(tmpA);
        tmpA = new ApparelItem("Gator Hat", Utils.gator_hat_tex, "Social", 1.0, 1, "A UF Gators hat. Go Gators!");
        items.add(tmpA);
        tmpA = new ApparelItem("Graduation Gown", Utils.graduation_gown_tex, "Endurance", 2.0, 1, "The robe that seniors get to\nwear.");
        items.add(tmpA);
        ...
        items.add(tmpC);
        tmpC = new ConsumableItem("Quiz Drop",Utils.quiz_drop_tex,"Defense",-1.0,2,2,true, "Take less damage from your\nworkload. Save for a\ntough class!");
        items.add(tmpC);
        tmpC = new ConsumableItem("Test Drop",Utils.test_drop_tex,"Defense",-1.0,4,2,true, "Take less damage from your\nworkload. Save for a\nreally tough class!");
        items.add(tmpC);
        tmpE = new EquipableItem("AVR Dragon", Utils.avr_dragon_tex, "Hardware", 3.0, 1, "A fancy board suitable for uP.");
        items.add(tmpE);
        tmpE = new EquipableItem("Cyclone III", Utils.cyclone_III_tex, "Hardware", 2.0, 1, "A good board to use in\nDigital Design.");
        items.add(tmpE);
        tmpE = new EquipableItem("DAD Board", Utils.dad_board_tex, "Focus", 1.0, 1, "Helps you carefully analyze\nall your outputs.");
        items.add(tmpE);
        tmpE = new EquipableItem("Macbook Pro", Utils.macbook_pro_tex, "Software", 1.0, 1, "Go Apple. xCode for dayz.");
        items.add(tmpE);
        tmpE = new EquipableItem("Nspire", Utils.nspire_tex, "Math", 2.0, 1, "Solves anything math-y.");
        items.add(tmpE);
        tmpE = new EquipableItem("Soldering Iron", Utils.soldering_iron_tex, "Endurance", 1.0, 1, "Solder your hardware together\nwith this.");
        items.add(tmpE);
        tmpE = new EquipableItem("TI-89", Utils.ti_89_tex, "Math", 1.0, 1, "Makes math stuff easier.");
        items.add(tmpE);
        tmpE = new EquipableItem("USB Blaster", Utils.usb_blaster_tex, "Software", 2.0, 1, "This lets you program your\nboard.");
        items.add(tmpE);
